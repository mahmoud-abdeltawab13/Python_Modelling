...
def Omega_Optimum(fu_initial,Fref,PM_deg,Ip,Kvco,Fout,R_divider,P_divider,N):

    Total_RMS_Jitter_final=list()
    j_final=list()
    
    
    f_start=fu_initial/1E6
    fu=np.linspace(f_start-3,f_start+3,40)
    ...
    for y,j in enumerate(omega_u):
        ...
        Total_Out_PN_mag=PN_Buffer_OUT_mag+PN_P_Divider_OUT_mag+PN_R_Divider_OUT_mag+PN_CP_OUT_mag+PN_N_Divider_OUT_mag+PN_LF_OUT_mag+PN_VCO_OUT_mag+PN_REF_OUT_mag
        ...
        ####JITTER CALCULATION
        #TOTAL RMS JITTER
        Total_Integral=np.trapz(10**(Total_Out_PN/10),x=(w/(2*np.pi)))
    ...
    #print("Total RMS JITTER=",Total_RMS_Jitter_final)
    #print("Min RMS jitter= ",min_jitter*1E15,"fsec")
    return j_final[index_of_min_jitter]*1E6
    # print("Optimum Loop BW= ",j_final[index_of_min_jitter],"MHz")
    # print("Optimum PM= ",PM_final[index_of_min_jitter],"deg")
